...
- Clean and structure messy datasets with SQL (SQLite, PostgreSQL, SQL Server)
- Answer specific business questions through descriptive analysis — grounded findings, not black-box predictions
- Build interactive dashboards in Power BI, backed by DAX measures
- Document every project as a reproducible case study, from raw data to final recommendation
